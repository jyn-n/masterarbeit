...
\end{Lemma}
\proof
%TODO \F_1, falls definition geaendert
Consider a configuration \IM{c \in A(M^\prime) \cup R(M^\prime)}, that is $M^\prime$ stops for $c$. Call one of its tapes \IM{z \in (\Z_2^k)^\Z}.
