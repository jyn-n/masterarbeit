...
\begin{Theorem} \label{turing_machines:main_theorem:theorem}
...
\end{Theorem}
\footnotetext{For a thorough understanding of this notion of similarity between Turing machines see \cite{rog96}}
\proof
